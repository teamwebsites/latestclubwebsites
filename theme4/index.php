...
<div class="homepage-welcome clubsponsor-homepage">
    
<div class="welcome-text">
    
<div>
    
<?php if ( get_theme_mod( 'animals_clubsponsor' ) ) : ?>  

<a href="<?php echo esc_url( get_theme_mod( 'primaryclubsponsor_url' ) ); ?>" title="Official Sponsor/Partner of <?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>">



<img src="<?php echo esc_url( get_theme_mod( 'animals_clubsponsor' ) ); ?>" title="Official Sponsor/Partner of <?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" alt="Official Sponsor of <?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>">   
