<style>header .top-header-st {background: #fff !important;}</style>
...
<a href="https://www.twitter.com/<?php echo get_theme_mod( 'twitter_user_name' ); ?>" class="social_media_link"  target="_blank" title="Twitter" id="twitter-social">
...
<a href="<?php echo esc_url( get_theme_mod( 'fb_pg_url' ) ); ?>" class="social_media_link" target="_blank" title="Facebook" id="facebook-social">
...
<a href="https://www.instagram.com/<?php echo get_theme_mod( 'instagram_user_name' ); ?>" class="social_media_link" target="_blank" title="Instagram" id="instagram-social">
...
<style>#Demo1 a{color: #<?php echo get_theme_mod( 'blognametxtcolor' ); ?> !important;}</style>

<nav id="site-navigation" class="desktopav nav-primary fullwidthnav main-navigation" role="navigation">
