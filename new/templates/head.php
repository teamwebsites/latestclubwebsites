...
.welcome-home {background-position: <?php
    $hpmainimagelead_position = get_theme_mod( 'hpmainimage_bgposition' );
...
.welcome-home {background: url(<?php echo esc_url (get_theme_mod( 'homepagemainimage', 'https://teamwebsites.co.uk/images/soccer.jpg' )); ?>);}
...
#welcome h3 {border-bottom: 2px solid <?php echo get_theme_mod( 'primary_color_scheme' ); ?>;}
